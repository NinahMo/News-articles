...
#         Set up method that will run before every Test
#         '''
#         self.new_article = Articles('CNN','Ninah Mosoti','The tech scene in Africa, is it the next big thing?','Take a look at various tech hubs in Africa and the impact they have on the worlds economy','tekh.com','tekh.com/7643t94.jpg','2018-04-11T07:57:16Z')
...
#         self.assertEquals(self.new_article.author,'Ninah Mosoti')
...
#         self.assertEquals(self.new_article.url,'tekh.com')
#         self.assertEquals(self.new_article.image,'tekh.com/7643t94.jpg')
